...
function pum_schedule_single_action( $timestamp, $hook, $args = [] ) {
	return as_schedule_single_action( $timestamp, $hook, $args = array(), 'popup-maker' );
}
 ...
 * @return void
 */
function pum_unschedule_all_actions( $hook, $args = [] ) {
	as_unschedule_all_actions( $hook, $args, 'popup-maker' );
}
 ...
 */
function pum_next_scheduled_action( $hook, $args = NULL ) {
