			...
			<div id="loading_condition-<?php echo $key; ?>" class="loading_condition form-table">
				...
				<div class="options">
					<p style="margin:0;"><?php
						...
						<input type="checkbox" style="display:none" name="popup_loading_condition_<?php echo $key; ?>" value="true" <?php if(isset($loading_condition[$key])) echo 'checked'; ?>/>
						<label><?php
					...
					<div id="<?php echo $key; ?>">
						<div class="nojs-tags hide-if-js">
							<textarea
								name="popup_loading_condition_<?php echo $include_exclude == 'exclude' ? 'exclude_' : '';?>on_<?php echo $pt; ?>"
								rows="3" cols="20"
								id="popup_loading_condition_<?php echo $include_exclude == 'exclude' ? 'exclude_' : '';?>on_<?php echo $pt; ?>"
