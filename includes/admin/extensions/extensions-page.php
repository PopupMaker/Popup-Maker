...
function pum_extensions_page_subtabs() {
	return apply_filters( 'pum_integrations_tabs', array(
 ...
 * @return array
 */
function pum_extensions_page_form_plugins() {
	$form_plugins = array(
		array(
			'slug' => 'gravity-forms',
 ...
 */
function pum_extensions_page_available_extensions() {
...
function pum_render_extensions_page_subtabs() {
	...
	$form_plugins  = pum_extensions_page_form_plugins();
	$extensions    = pum_extensions_page_available_extensions();
	$other_plugins = pum_extensions_page_other_plugins(); ?>
		...
		<div id="post-body-content">
			...
			<div class="pum-tabs-container">
				<?php if ( 'forms' === $active_tab ) {
					pum_render_extensions_page_forms_list();
				} elseif ( 'other' === $active_tab ) {

				} else { ?>

					<?php pum_render_extensions_page_extension_list(); ?>
