...
override(\PopupMaker\Plugin\Core::get_controller(0), map([
    ...
    'Admin\Toolbar' => \PopupMaker\Controllers\Admin\Toolbar::class,
    'Admin\ToolbarNotifications' => \PopupMaker\Controllers\Admin\ToolbarNotifications::class,
    'Admin\CallToActions' => \PopupMaker\Controllers\Admin\CallToActions::class,
    'Admin\WP\PluginsPage' => \PopupMaker\Controllers\Admin\WP\PluginsPage::class,
