...
class PUM_Admin_PopupThemes {
	...
	public static function meta_box() {
		add_meta_box( 'pum_theme_settings', __( 'Popup Theme Settings', 'popup-maker' ), array( __CLASS__, 'render_settings_meta_box' ), 'popup_theme', 'normal', 'high' );
	}
	...
	public static function render_settings_meta_box() {
		...
		$popup = pum_get_popup_theme( $post->ID, true );
