...
!function (e, t, o) {
    ...
    e.fn.popmake.cookie = {
        defaults: {}, raw: !1, json: !0, pluses: /\+/g, encode: function (t) {
            ...
            var p, r, c, m, l, u = n ? o : {}, f = new Date, d = t.cookie ? t.cookie.split("; ") : [];
    ...
    e.fn.popmake.utilities = {
        convert_hex: function (e, t) {
            ...
            function i(e) {
                ...
                if (a && (p *= parseInt(o, 10)), l.hasOwnProperty(i) && !t[1].match(/^mon(day|\.)?$/i))return c["set" + l[i]](c["get" + l[i]]() + p);
                if ("wee" === i)return c.setDate(c.getDate() + 7 * p);
                if ("next" === o || "last" === o)n(o, i, p); else if (!a)return !1;
                return !0
            }

            var a, s, p, r, c, m, l, u, f, d, g, h = !1;
            if (!e)return h;
            ...
            for (g = 0, u = s.length; u > g; g += 1)if (!i(s[g]))return h;
