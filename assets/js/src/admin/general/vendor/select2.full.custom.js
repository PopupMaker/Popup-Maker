...
( function ( factory ) {
	...
	var S2 = ( function () {
		...
		if (
			jQuery &&
			jQuery.fn &&
			jQuery.fn.pumselect2 &&
			jQuery.fn.pumselect2.amd
		) {
		...
		S2.define( 'pumselect2/utils', [ 'jquery' ], function ( $ ) {
			var Utils = {};
		...
		S2.define(
			...
			function ( $, Utils ) {
				...
				Results.prototype.hideMessages = function () {
					this.$results
						.find( '.pumselect2-results__message' )
						.remove();
				};
				...
				Results.prototype.setClasses = function () {
					...
					this.data.current( function ( selected ) {
						...
						var $options = self.$results.find(
							'.pumselect2-results__option[aria-selected]'
						);
		...
		S2.define( 'pumselect2/keys', [], function () {
			var KEYS = {
				BACKSPACE: 8,
				TAB: 9,
				ENTER: 13,
		...
		S2.define(
			...
			function ( $, Utils, KEYS ) {
				...
				BaseSelection.prototype._attachCloseHandler = function (
					...
					$( document.body ).on(
						'mousedown.pumselect2.' + container.id,
						function ( e ) {
							var $target = $( e.target );
							...
							var $all = $(
								'.pumselect2.pumselect2-container--open'
							);
		...
		S2.define(
			...
			function ( $, BaseSelection, Utils, KEYS ) {
				...
				SingleSelection.prototype.bind = function (
					...
					this.$selection
						.find( '.pumselect2-selection__rendered' )
						.attr( 'id', id );
		...
		S2.define(
			'pumselect2/selection/placeholder',
			[ '../utils' ],
			function ( Utils ) {
				...
				Placeholder.prototype.createPlaceholder = function (
					...
					$placeholder
						.addClass( 'pumselect2-selection__placeholder' )
		...
		S2.define(
			'pumselect2/selection/allowClear',
			[ 'jquery', '../keys' ],
			function ( $, KEYS ) {
				function AllowClear() {}
		...
		S2.define(
			'pumselect2/selection/eventRelay',
			[ 'jquery' ],
			function ( $ ) {
				function EventRelay() {}
		...
		S2.define( 'pumselect2/diacritics', [], function () {
			var diacritics = {
				'\u24B6': 'A',
				'\uFF21': 'A',
				'\u00C0': 'A',
		...
		S2.define( 'pumselect2/data/base', [ '../utils' ], function ( Utils ) {
		...
		S2.define( 'pumselect2/data/tags', [ 'jquery' ], function ( $ ) {
			...
			Tags.prototype._removeOldTags = function ( _ ) {
				...
				var $options = this.$element.find(
					'option[data-pumselect2-tag]'
				);
		...
		S2.define( 'pumselect2/data/tokenizer', [ 'jquery' ], function ( $ ) {
		...
		S2.define( 'pumselect2/data/minimumInputLength', [], function () {
		...
		S2.define( 'pumselect2/data/maximumInputLength', [], function () {
		...
		S2.define( 'pumselect2/data/maximumSelectionLength', [], function () {
		...
		S2.define( 'pumselect2/dropdown/hidePlaceholder', [], function () {
		...
		S2.define(
			'pumselect2/dropdown/infiniteScroll',
			[ 'jquery' ],
			function ( $ ) {
		...
		S2.define(
			'pumselect2/dropdown/attachBody',
			[ 'jquery', '../utils' ],
			function ( $, Utils ) {
				...
				AttachBody.prototype._attachPositioningHandler = function (
					...
					var orientationEvent =
						'orientationchange.pumselect2.' + container.id;
				...
				AttachBody.prototype._positionDropdown = function () {
					...
					if ( newDirection != null ) {
						this.$dropdown
							.removeClass(
								'pumselect2-dropdown--below pumselect2-dropdown--above'
							)
							.addClass( 'pumselect2-dropdown--' + newDirection );
						this.$container
							.removeClass(
								'pumselect2-container--below pumselect2-container--above'
							)
							.addClass(
								'pumselect2-container--' + newDirection
							);
					}
		...
		S2.define(
			'pumselect2/dropdown/minimumResultsForSearch',
			[],
			function () {
		...
		S2.define( 'pumselect2/dropdown/selectOnClose', [], function () {
		...
		S2.define( 'pumselect2/dropdown/closeOnSelect', [], function () {
			...
			function ( $, Options, Utils, KEYS ) {
				...
				Select2.prototype.render = function () {
					...
					this.$container.addClass(
						'pumselect2-container--' + this.options.get( 'theme' )
					);
		...
		S2.define( 'pumselect2/compat/utils', [ 'jquery' ], function ( $ ) {
		...
		S2.define(
			'pumselect2/compat/containerCss',
			[ 'jquery', './utils' ],
		...
		S2.define(
			'pumselect2/compat/initSelection',
			[ 'jquery' ],
			function ( $ ) {
		...
		S2.define( 'pumselect2/compat/inputData', [ 'jquery' ], function ( $ ) {
		...
		S2.define( 'pumselect2/compat/matcher', [ 'jquery' ], function ( $ ) {
		...
		S2.define( 'pumselect2/compat/query', [], function () {
		...
		S2.define( 'pumselect2/dropdown/attachContainer', [], function () {
		...
		S2.define( 'pumselect2/dropdown/stopPropagation', [], function () {
		...
		S2.define( 'pumselect2/selection/stopPropagation', [], function () {
			function StopPropagation() {}
