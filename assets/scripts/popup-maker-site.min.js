...
a.container.background_opacity),borderStyle:a.container.border_style,borderColor:a.container.border_color,borderWidth:a.container.border_width+"px",borderRadius:a.container.border_radius+"px",boxShadow:d+a.container.boxshadow_horizontal+"px "+a.container.boxshadow_vertical+"px "+a.container.boxshadow_blur+"px "+a.container.boxshadow_spread+"px "+c.fn.popmake.utilities.convert_hex(a.container.boxshadow_color,a.container.boxshadow_opacity)});g.css({color:a.title.font_color,lineHeight:a.title.line_height+
"px",fontSize:a.title.font_size+"px",fontFamily:a.title.font_family,fontWeight:a.title.font_weight,fontStyle:a.title.font_style,textAlign:a.title.text_align,textShadow:a.title.textshadow_horizontal+"px "+a.title.textshadow_vertical+"px "+a.title.textshadow_blur+"px "+c.fn.popmake.utilities.convert_hex(a.title.textshadow_color,a.title.textshadow_opacity)});f.css({color:a.content.font_color,fontFamily:a.content.font_family,fontWeight:a.content.font_weight,fontStyle:a.content.font_style});c("p, label",
f).css({color:a.content.font_color,fontFamily:a.content.font_family});h.html(a.close.text).css({padding:a.close.padding+"px",backgroundColor:c.fn.popmake.utilities.convert_hex(a.close.background_color,a.close.background_opacity),color:a.close.font_color,lineHeight:a.close.line_height+"px",fontSize:a.close.font_size+"px",fontWeight:a.close.font_weight,fontStyle:a.close.font_style,fontFamily:a.close.font_family,borderStyle:a.close.border_style,borderColor:a.close.border_color,borderWidth:a.close.border_width+
"px",borderRadius:a.close.border_radius+"px",boxShadow:k+a.close.boxshadow_horizontal+"px "+a.close.boxshadow_vertical+"px "+a.close.boxshadow_blur+"px "+a.close.boxshadow_spread+"px "+c.fn.popmake.utilities.convert_hex(a.close.boxshadow_color,a.close.boxshadow_opacity),textShadow:a.close.textshadow_horizontal+"px "+a.close.textshadow_vertical+"px "+a.close.textshadow_blur+"px "+c.fn.popmake.utilities.convert_hex(a.close.textshadow_color,a.close.textshadow_opacity)});switch(a.close.location){case "topleft":h.css({top:a.close.position_top+
...
void 0!==a&&a()}}))})});return this}};c(".popmake").css({visibility:"visible"}).hide();c(document).ready(function(){c(".popmake").popmake().each(function(){var a=c(this),e=a.data("popmake"),d=e.meta.click_open,b=".popmake-"+e.id+", .popmake-"+e.slug,g=e.meta.auto_open,f;void 0!==d.extra_selectors&&""!==d.extra_selectors&&(b+=", "+d.extra_selectors);c(b).css({cursor:"pointer"});c(document).on("click",b,function(b){b.preventDefault();b.stopPropagation();c.fn.popmake.last_open_trigger=c.fn.popmake.utilities.getXPath(this);
a.popmake("open")});if(void 0!==g&&g.enabled){f=function(){return void 0===c.pm_cookie("popmake-auto-open-"+e.id+"-"+g.cookie_key)};a.on("setCookie",function(){""!==g.cookie_time&&f()&&c.pm_cookie("popmake-auto-open-"+e.id+"-"+g.cookie_key,!0,g.cookie_time,g.cookie_path)});switch(g.cookie_trigger){case "open":a.on("popmakeAfterOpen",function(){a.trigger("setCookie")});break;case "close":a.on("popmakeBeforeClose",function(){a.trigger("setCookie")})}setTimeout(function(){f()&&(c.fn.popmake.last_open_trigger=
"Auto Open Popups ID-"+e.id,a.popmake("open"))},g.delay)}})})})(jQuery);