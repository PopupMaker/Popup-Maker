...
at:d.at+" bottom"}),d.my=c.trim(d.my),d.at=c.trim(d.at)}d.of=window;d.collision="none";return d}};c.fn.popmake.callbacks={reposition_using:function(a){c(this).css(a)}};c.fn.popmake.utilities={convert_hex:function(a,e){a=a.replace("#","");var d=parseInt(a.substring(0,2),16),b=parseInt(a.substring(2,4),16),c=parseInt(a.substring(4,6),16);return"rgba("+d+","+b+","+c+","+e/100+")"},debounce:function(a,e){var d;return function(){var b=this,c=arguments;window.clearTimeout(d);d=window.setTimeout(function(){a.apply(b,
c)},e)}},throttle:function(a,e){var d=!1,b=function(){d=!1};return function(){d||(a.apply(this,arguments),window.setTimeout(b,e),d=!0)}},getXPath:function(a){var e=[],d,b,g,f,h;c.each(c(a).parents(),function(a,l){d=c(l);b=d.attr("id")||"";g=d.attr("class")||"";f=d.get(0).tagName.toLowerCase();h=d.parent().children(f).index(d);if("body"===f)return!1;0<g.length&&(g=g.split(" "),g=g[0]);e.push(f+(0<b.length?"#"+b:0<g.length?"."+g.split(" ").join("."):":eq("+h+")"))});return e.reverse().join(" > ")},
strtotime:function(a,e){function d(a){var b=a.split(" ");a=b[0];var c=b[1].substring(0,3),d=/\d+/.test(a),e=("last"===a?-1:1)*("ago"===b[2]?-1:1);d&&(e*=parseInt(a,10));if(k.hasOwnProperty(c)&&!b[1].match(/^mon(day|\.)?$/i))return f["set"+k[c]](f["get"+k[c]]()+e);if("wee"===c)return f.setDate(f.getDate()+7*e);if("next"===a||"last"===a)b=e,c=h[c],void 0!==c&&(c-=f.getDay(),0===c?c=7*b:0<c&&"last"===a?c-=7:0>c&&"next"===a&&(c+=7),f.setDate(f.getDate()+c));else if(!d)return!1;return!0}var b,c,f,h,k,
...
void 0!==a&&a()}}))})});return this}};c(".popmake").css({visibility:"visible"}).hide();c(document).ready(function(){c(".popmake").popmake().each(function(){var a=c(this),e=a.data("popmake"),d=e.meta.click_open,e=".popmake-"+e.id+", .popmake-"+e.slug;void 0!==d&&""!==d.extra_selectors&&(e+=", "+d.extra_selectors);c(e).css({cursor:"pointer"});c(document).on("click",e,function(b){b.preventDefault();b.stopPropagation();c.fn.popmake.last_open_trigger=c.fn.popmake.utilities.getXPath(this);a.popmake("open")})})})})(jQuery);