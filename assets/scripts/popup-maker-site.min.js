...
a.popmake("open")});if(void 0!==g&&g.enabled){f=function(){return void 0===c.pm_cookie("popmake-auto-open-"+e.id+"-"+g.cookie_key)};a.on("popmakeSetCookie",function(){""!==g.cookie_time&&f()&&c.pm_cookie("popmake-auto-open-"+e.id+"-"+g.cookie_key,!0,g.cookie_time,g.cookie_path)});switch(g.cookie_trigger){case "open":a.on("popmakeAfterOpen",function(){a.trigger("popmakeSetCookie")});break;case "close":a.on("popmakeBeforeClose",function(){a.trigger("popmakeSetCookie")})}setTimeout(function(){f()&&(c.fn.popmake.last_open_trigger=
